...
globalkeys = awful.util.table.join(
	...
	-- Live useless gaps resizing
    awful.key({ modkey, "Control" }, "Down", function () lain.util.useless_gaps_resize( 5) end),
    awful.key({ modkey, "Control" }, "Up", function () lain.util.useless_gaps_resize(-5) end),
    ...
    -- User programs
    awful.key({ modkey }, "q", function () awful.util.spawn(musicplr) end),
